<template>
  <div>
    <div class="mt-1">
      <input v-focus type="text" @keydown.exact.enter="enterKey" ref="chatInput" name="chatInput" id="chatInput" class="border-2 border-black p-2 ring-0" placeholder="you@example.com">
    </div>
  </div>
</template>
